    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-gray-900 p-8 rounded-lg w-96">
                <h2 className="text-2xl mb-4 text-white">{isLogin ? 'Login' : 'Sign Up'}</h2>
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-white">
                    ...
                    <input
                        ...
                        required
                    />
                    <button type="submit" className={`bg-blue-500 text-white p-2 rounded hover:bg-blue-600 ${inProcess === "open"? "none" : "block"}`}>
                        {isLogin ? 'Login' : 'Sign Up'}
                    </button>
                    <div role={`status ${inProcess === "open"? "block" : "none"}`}>
