...
const Friend = ({friend}) => {
    ...
    return (
        <li
            ...
            className="flex flex-col md:flex-row bg-gray-950 hover:bg-gray-600 transition-colors rounded-lg p-4 text-center cursor-pointer ring-2 ring-transparent hover:ring-blue-400"
